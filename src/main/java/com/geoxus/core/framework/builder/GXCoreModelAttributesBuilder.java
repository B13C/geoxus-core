...
public class GXCoreModelAttributesBuilder implements GXBaseBuilder {
    ...
    public String listOrSearch(Dict param) {
        final SQL sql = new SQL().SELECT(
                "ca.field_name", "ca.attribute_id", "ca.show_name", "ca.category", "ca.data_type",
    ...
    public String checkCoreModelHasAttribute(Dict param) {
        ...
        subSql = subSql.concat("\nWHERE (core_attributes.field_name = '{field_name}' AND core_model_attributes.model_id = {core_model_id}) LIMIT 1");
