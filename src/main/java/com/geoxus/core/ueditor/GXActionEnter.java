...
public class GXActionEnter {
    private GXEditorUploader editorUploader;

    private GXEditorProperties properties = GXSpringContextUtils.getBean(GXEditorProperties.class);

    private HttpServletRequest request;

    private String actionType;

    private GXConfigManager configManager;
